...
goto :finende
:ende
	 endlocal & echo. & echo "So das wars, im Ordner wo du das hier aktiviert hast liegen jetzt die Video(s). Öffne die Videos am besten mit VLC Du kanst das  hier schließen." & call 0systemTrayNotification.exe -tooltip warning -time 300000 -title "Fertig" -text "So das wars, im Ordner wo du das hier aktiviert hast liegen jetzt die Video(s). Öffne die Videos am besten mit VLC" -icon question &	 pause
		:finende
